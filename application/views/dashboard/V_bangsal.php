    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Milestone</h3> &nbsp; <a class="btn btn-primary btn-xs" href="#" id="btn-tambah">Tambah</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="tbBangsal" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    <th>No.</th>
                    <th>ID Milestone</th>
...
<script>
  $(function() {
    ...
    const showTable = () => {
      let tableBangsal = $('#tbBangsal').DataTable({
        "destroy": true,
        "bProcessing": true,
        "bAutoWidth": false,
        "bFilter": true,
